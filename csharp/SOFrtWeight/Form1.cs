...
namespace SOFrtWeight
{
    public partial class Form1 : Form
    {
        ...
        public Form1(string[] args)
        {
            InitializeComponent();
            strCompany = args[0];
            intSONum = Convert.ToInt32(args[1]);
            strEditLabel = args[2];
        }
        ...
        private void refreshQuoteCalcWeight()
        {
            ...
            command = new SqlCommand("[dbo].sp_SO_CalcWeight", conn);
            ...
            command.Parameters.Add("@Ordernum", SqlDbType.Int, 15).Value = intSONum;
        ...
        {
            if (intSONum.ToString().Trim().Length > 0)
            {
