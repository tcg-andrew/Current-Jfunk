...
namespace Styleline.WinAnalyzer.WinClient
{
    ...
    class ReportPrintDocument : PrintDocument
    {
        ...
        private ReportPrintDocument(Report report)
        {
            ...
            /* DOE */
            m_pageSettings.PaperSize = new PaperSize("Custom", 850, 125);
            /* Non DOE */
            //m_pageSettings.PaperSize = new PaperSize("Custom", 850, 200);
            m_pageSettings.PrinterResolution.X = 203;
            m_pageSettings.PrinterResolution.Y = 203;
